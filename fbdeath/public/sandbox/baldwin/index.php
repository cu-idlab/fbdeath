    ...
    <div id="myCarousel" class="carousel">
      <div class="carousel-inner">
        <div class="item active">
          <img src="http://farm6.staticflickr.com/5449/8877648076_9b99a76bf8_k.jpg" alt="">
          <div class="container">
            <div class="carousel-caption">
              	         <?php
	          				if ($epilogue->is_loggedin()) {
	          					...
	          					echo '<h1 style="font-size:5em;">Epilogue</h1>
	          					<a href="'. $loginUrl .'"><button class="btn btn-primary btn-large"><i class="icon-facebook"></i> | Connect to Facebook</button></a>
	          					';
	          				}
	          			?>
            </div>
